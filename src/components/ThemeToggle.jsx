...
const ThemeToggle = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-6 right-6 z-50 w-8 h-8 rounded-full bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 flex items-center justify-center group"
